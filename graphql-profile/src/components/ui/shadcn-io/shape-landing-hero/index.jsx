      ...
      <motion.div
        ...
        <div
          className={cn(
            ...
            "shadow-[0_8px_32px_0_rgba(201,242,77,0.1)]",
            "after:absolute after:inset-0 after:rounded-2xl",
            "after:bg-[radial-gradient(circle_at_50%_50%,rgba(201,242,77,0.2),transparent_70%)]"
          )} />
      </motion.div>
    </motion.div>
  );
...
export function HeroGeometric({
  ...
  return (
    <div
      ...
      <div
        className="absolute inset-0 bg-gradient-to-br from-[#C9F24D]/[0.05] via-transparent to-[#C9F24D]/[0.05] blur-3xl" />
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
            <h1
              ...
              <span
                className={cn(
                  "bg-clip-text text-transparent bg-gradient-to-r from-[#C9F24D] via-white/90 to-[#C9F24D]"
                )}>
                {title2}
              </span>
            </h1>
